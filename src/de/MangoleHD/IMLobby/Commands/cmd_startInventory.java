...
public class cmd_startInventory {
    ...
    public void execute(Player p) {
        ...
        comp.setLore(Arrays.asList(new String[]{Data.dsp.get("startinventory.lore.teleporter", getLanguage(UUIDFetcher.getUUID(p.getName())))}));
        ...
        sett.setLore(Arrays.asList(new String[]{Data.dsp.get("startinventory.lore.settings", getLanguage(UUIDFetcher.getUUID(p.getName())))}));
        ...
        ender.setLore(Arrays.asList(new String[]{Data.dsp.get("startinventory.lore.beam", getLanguage(UUIDFetcher.getUUID(p.getName())))}));
       ...
       n.setLore(Arrays.asList(new String[]{Data.dsp.get("startinventory.lore.news", getLanguage(UUIDFetcher.getUUID(p.getName())))}));
        news.setItemMeta(n);
        ...
        visimeta.setLore(Arrays.asList(new String[]{Data.dsp.get("startinventory.lore.visibility", getLanguage(UUIDFetcher.getUUID(p.getName())))}));
